...
export default class Display extends React.Component {
	...
	componentDidMount() {
		...
		const val = (280-(getOutput([rating1, rating2, rating3, rating4])*280))+80;
		const val2 = ((getOutput([rating1, rating2, rating3, rating4])*280))+80;
		...
		return (
			<View style={styles.container}>
				...
				<Animated.View style={[styles.redView, {...this.props.style, height:redAnim}]}>
					...
					<Text style={[styles.text, {marginTop:20}]}>{red2}</Text>
				</Animated.View>
			</View>
		);
	}
